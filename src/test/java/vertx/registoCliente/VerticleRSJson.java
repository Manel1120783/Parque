...
import vertx.registoCliente.Handlers;
...
public class VerticleRSJson extends AbstractVerticle {
    ...
    String Sinf1_grupoA_5 = DEFAULT_WEB_ROOT;
    Router router;
    ...
    private Router routes(Handlers handlers) {
        ...
        router.route().handler(StaticHandler.create().setWebRoot(Sinf1_grupoA_5));
        // serve index
        router.route("/").handler(StaticHandler.create(Sinf1_grupoA_5));
